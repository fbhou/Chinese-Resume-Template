...
\name{鞠泉玺}
\contactInfo{1980568850}{qxju2020@sjtu.edu.cn}
\section{教育背景}

\datedsubsection{\textbf{上海交通大学}，信息工程，\textit{本科}}{2020.09 - 至今}

\section{实习经历}

\datedsubsection{\textbf{中国电力建设集团成都勘测设计研究院有限公司数字工程分公司}}{2022.07-2022.08}
\begin{itemize}[parsep=0.5ex]
  \item 后端Java开发工程师
\end{itemize}
\section{项目经历}

\datedsubsection{\textbf{RNA功能相关预测与RNA设计}}{2023.03 - }
\begin{itemize}[parsep=0.5ex]
...
\datedsubsection{\textbf{水风光储一体化多能互补计算平台}}{2022.07-2022.08}
\begin{itemize}[parsep=0.5ex]
...
\datedsubsection{\textbf{人体手势照片识别与分类}}{2022.05 - 2022.06}
\begin{itemize}[parsep=0.5ex]
...
\datedsubsection{\textbf{基于遗传算法的矩阵特征值求解}}{2020.12 - 2021.01}
\begin{itemize}[parsep=0.5ex]
...
\datedsubsection{\textbf{智能开关窗器设计与原型制作}}{2020.10 - 2020.12}
\begin{itemize}[parsep=0.5ex]
...
\datedsubsection{\textbf{基于神经网络的字母灰度图像去噪}}{2018.10 - 2018.11}
\begin{itemize}[parsep=0.5ex]
